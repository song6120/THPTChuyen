...
namespace THPTChuyen.Areas.Admin.Controllers
{
    public class LienHesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaLienHe,Email,SDT,DiaChi,FaceBook")] LienHe lienHe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLienHe,Email,SDT,DiaChi,FaceBook")] LienHe lienHe)
        {
            if (ModelState.IsValid)
            {
