...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserImageUrl = "/Content/Admin/plugin/ckfinder/ckfinder.html?type=Images";
    config.filebrowserFlashUrl = "/Content/Admin/plugin/ckfinder/ckfinder.html?type=Flash";
    ...
    config.filebrowserImageUploadUrl = "/Content/Admin/plugin/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Images";
